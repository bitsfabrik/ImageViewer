...
func defaultGalleryConfiguration() -> GalleryConfiguration {
    ...
    closeButton.setImage(UIImage(named: "ImageViewer.bundle/close_normal"), forState: UIControlState.Normal)
    closeButton.setImage(UIImage(named: "ImageViewer.bundle/close_highlighted"), forState: UIControlState.Highlighted)
